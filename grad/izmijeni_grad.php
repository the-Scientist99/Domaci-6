...
$q = "SELECT * FROM grad WHERE id = '$id'";
...
<body>
    <div class="container">
        ...
        <div class="text-center row mt-5">
            ...
            <div class="col-4">
                <h2>Izmijeni Grad</h2>
                <form action="./izmijeni_grad_db.php" class="form d-flex flex-column" method="GET">
                    <input type="hidden" name="id" class="form-control" value="<?= $id ?>">
                    <input type="text" name="naziv" class="form-control my-2" value="<?= $grad['naziv'] ?>">
